...
(function (Khulnasoft) {
    ...
    })(ApplicationInsights = Khulnasoft.ApplicationInsights || (Khulnasoft.ApplicationInsights = {}));
...
(function (Khulnasoft) {
    ...
    (function (Telemetry) {
        ...
        Telemetry.Base = Base;
    })(Telemetry = Khulnasoft.Telemetry || (Khulnasoft.Telemetry = {}));
})(Khulnasoft || (Khulnasoft = {}));
var Khulnasoft;
(function (Khulnasoft) {
    var Telemetry;
    ...
    (function (ApplicationInsights) {
        ...
        (function (Telemetry) {
            ...
            var Trace = (function (_super) {
                ...
                Trace.envelopeType = "Khulnasoft.ApplicationInsights.Message";
    ...
    (function (ApplicationInsights) {
        ...
        (function (Telemetry) {
            ...
            var Event = (function (_super) {
                ...
                Event.envelopeType = "Khulnasoft.ApplicationInsights.Event";
    ...
    (function (ApplicationInsights) {
        ...
        (function (Telemetry) {
            ...
            var Exception = (function (_super) {
                ...
                Exception.envelopeType = "Khulnasoft.ApplicationInsights.Exception";
        ...
        (function (Telemetry) {
            ...
            var Metric = (function (_super) {
                ...
                function Metric(name, value, count, min, max, properties) {
                    ...
                    var dataPoint = new Khulnasoft.ApplicationInsights.Telemetry.Common.DataPoint();
                ...
                Metric.envelopeType = "Khulnasoft.ApplicationInsights.Metric";
    ...
    (function (ApplicationInsights) {
        ...
        (function (Telemetry) {
            ...
            var PageView = (function (_super) {
                ...
                PageView.envelopeType = "Khulnasoft.ApplicationInsights.Pageview";
    ...
    (function (ApplicationInsights) {
        ...
        (function (Telemetry) {
            ...
            var PageViewPerformance = (function (_super) {
                ...
                PageViewPerformance.envelopeType = "Khulnasoft.ApplicationInsights.PageviewPerformance";
    ...
    (function (ApplicationInsights) {
        ...
        (function (Telemetry) {
            ...
            var SessionTelemetry = (function (_super) {
                ...
                SessionTelemetry.envelopeType = "Khulnasoft.ApplicationInsights.SessionState";
        ...
        var Initialization = (function () {
            function Initialization(snippet) {
                ...
                if (config && !config.instrumentationKey) {
                    config = snippet;
                    if (config["iKey"]) {
                        Khulnasoft.ApplicationInsights.Version = "0.10.0.0";
                        config.instrumentationKey = config["iKey"];
                    }
                    else if (config["applicationInsightsId"]) {
                        Khulnasoft.ApplicationInsights.Version = "0.7.2.0";
            ...
            Initialization.prototype.loadAppInsights = function () {
                var appInsights = new Khulnasoft.ApplicationInsights.AppInsights(this.config);
                if (this.config["iKey"]) {
            ...
            Initialization.prototype.emptyQueue = function () {
                try {
                    if (Khulnasoft.ApplicationInsights.Util.isArray(this.snippet.queue)) {
                    ...
                    Khulnasoft.ApplicationInsights._InternalLogging.throwInternalNonUserActionable(1 /* WARNING */, message);
                }
            };
            Initialization.prototype.pollInteralLogs = function (appInsightsInstance) {
                return setInterval(function () {
                    var queue = Khulnasoft.ApplicationInsights._InternalLogging.queue;
            ...
            Initialization.prototype.addHousekeepingBeforeUnload = function (appInsightsInstance) {
                if ('onbeforeunload' in window) {
                    ...
                    if (!Khulnasoft.ApplicationInsights.Util.addEventHandler('beforeunload', performHousekeeping)) {
                        Khulnasoft.ApplicationInsights._InternalLogging.throwInternalNonUserActionable(0 /* CRITICAL */, 'Could not add handler for beforeunload');
                    }
                }
            };
    ...
    try {
        if (typeof window !== "undefined" && typeof JSON !== "undefined") {
            ...
            if (window[aiName] === undefined) {
                Khulnasoft.ApplicationInsights.AppInsights.defaultConfig = Khulnasoft.ApplicationInsights.Initialization.getDefaultConfig();
            }
            else {
                var snippet = window[aiName] || {};
                var init = new Khulnasoft.ApplicationInsights.Initialization(snippet);
        ...
        Khulnasoft.ApplicationInsights._InternalLogging.warnToConsole('Failed to initialize AppInsights JS SDK: ' + e.message);
    }
}
