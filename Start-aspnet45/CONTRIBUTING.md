...
Please start a discussion or log a new issue on the [Home repo issue tracker](https://github.com/Khulnasoft/Start/issues).
...
1. Did you read the [documentation](https://github.com/Khulnasoft/Start/tree/master/docs)?
